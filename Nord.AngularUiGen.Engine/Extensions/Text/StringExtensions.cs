...
namespace Nord.AngularUiGen.Engine.Extensions.Text
{
  ...
  {
    private static HashSet<char> _numerals = new HashSet<char>(new[] {'0', '1', '2', '3', '4', '5', '6', '7', '9',});
    ...
    public static string ToSpaced(this string val)
    {
      ...
      var previousWasNumeral = _numerals.Contains(cArr[0]);

      for (var i = 1; i < cArr.Length; i++)
      {
        var currentIsNumeral = _numerals.Contains(cArr[i]);
