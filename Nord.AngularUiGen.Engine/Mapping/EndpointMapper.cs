  ...
  public static class EndpointMapper
  {
    public static IEnumerable<EndpointViewModel> GetEnpoints(Type controller)
    {
      ...
      var decoratedMethods = (
        ...
        {
          dmi.methodInfo,
          isPost = containsType(dmi.customAttribs, httpPostAttributeType), //.CustomAttributes Attribute.IsDefined(methodInfo, httpGetAttributeType), 
          isGet= containsType(dmi.customAttribs, httpGetAttributeType), //Attribute.IsDefined(methodInfo, httpPostAttributeType), 
          isEnumerable, hasReturnType, returnType
        }).ToList();
      ...
      var httpMethods = (from x in decoratedMethods
                     ...
                     let specialAuth = hasAuthorizeAttribute
                       ...
                       : null
                     select new { x.methodInfo, x.isGet, x.isPost, x.hasReturnType, x.returnType, x.isEnumerable, specialAuth, httpMethod }).ToList();
