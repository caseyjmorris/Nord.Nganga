...
namespace Nord.Nganga.Annotations.Attributes.Html
{
  ...
  public class SectionHtmlAttributeAttribute : Attribute
  {
    ...
    /// </summary>
    /// <remarks>
    /// If no field in this class declares a <see cref="Nord.Nganga.Annotations.Attributes.ViewModels.UiSectionAttribute"/> referring to this section the rule will not be applied.
    /// </remarks>
