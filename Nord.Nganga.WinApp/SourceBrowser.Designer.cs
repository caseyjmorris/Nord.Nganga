namespace Nord.Nganga.WinApp
{
  partial class SourceBrowser
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "SourceBrowser";
      this.Text = "SourceBrowser";
      this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.SourceBrowser_FormClosing);
      this.Load += new System.EventHandler(this.SourceBrowser_Load);
